...
public class ListarPersona extends JDialog {
    ...
    public ListarPersona() {
        ...
        panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Selecci√≥n:", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
    ...
    public static void loadPersona(int index) {
        ...
        switch (option) {
            ...
            case "Doctor":
                for (Persona persona : Clinica.getInstance().getMisPersonas()) {
                    if (persona instanceof Doctor) {
                        ...
                        rows[5] = ((Doctor) persona).isEnServicio() ? "SÌ" : "No";
                        model.addRow(rows);
                    }
                }
                break;
            ...
            case "Todos":
                ...
                break;
            default:
                System.out.println("OpciÛn no reconocida: " + option);
                break;
        }
    }
