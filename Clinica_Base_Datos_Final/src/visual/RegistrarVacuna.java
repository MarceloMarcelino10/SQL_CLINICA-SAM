...
public class RegistrarVacuna extends JDialog {
    ...
    public RegistrarVacuna(Vacuna modVacuna) {
        ...
        lblCodigo.setBounds(40, 19, 57, 14);
        panel.add(lblCodigo);

        JLabel lblNombre = new JLabel("Nombre:");
        lblNombre.setBounds(40, 52, 57, 14);
        panel.add(lblNombre);

        JLabel lblEnfermedades = new JLabel("Enfermedades:");
        lblEnfermedades.setBounds(58, 341, 87, 14);
        panel.add(lblEnfermedades);

        txtCodigo = new JTextField();
        txtCodigo.setEditable(false);
        txtCodigo.setText("" + Clinica.getInstance().obtenerMaximoIdVacuna());
        txtCodigo.setBounds(125, 16, 151, 20);
        panel.add(txtCodigo);
        txtCodigo.setColumns(10);
